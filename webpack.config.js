...
module.exports = {
    ...
    devServer: {
        ...
        compress: false,
        proxy: [
                { path: '/api/**', target: dhisConfig.baseUrl, bypass:bypass, changeOrigin: true },
                { path: '/dhis-web-commons-ajax-json/**', target: dhisConfig.baseUrl, bypass:bypass, changeOrigin: true },
                { path: '/dhis-web-commons-stream/**', target: dhisConfig.baseUrl, bypass:bypass, changeOrigin: true },
                { path: '/dhis-web-commons/**', target: dhisConfig.baseUrl, bypass:bypass, changeOrigin: true, proxyTimeout: 1000 * 60 * 5 },
